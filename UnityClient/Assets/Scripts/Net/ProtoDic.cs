...
namespace Proto
{
   public class ProtoDic
   {
      ...
      private static List<Type>_protoType = new List<Type>
      {
            ...
            typeof(FightResult),
            typeof(EnterFight),
            typeof(LoginReq_0X0101),
            typeof(LoginRes_0X0101),
       ...
       private static readonly Dictionary<RuntimeTypeHandle, MessageParser> Parsers = new Dictionary<RuntimeTypeHandle, MessageParser>()
       {
            ...
            {typeof(LoginReq_0X0101).TypeHandle,LoginReq_0X0101.Parser },
            {typeof(LoginRes_0X0101).TypeHandle,LoginRes_0X0101.Parser },
