...
private:
	...
	int maxNodeCount;
	static __thread class dtNodePool* m_tinyNodePool;	///< Pointer to small node pool.
	static __thread class dtNodePool* m_nodePool;		///< Pointer to node pool.
	static __thread class dtNodeQueue* m_openList;		///< Pointer to open list queue.

	dtStatus PrepareTinyNodePool() const;
	dtStatus PrepareNodePool() const;
	dtStatus PrepareOpenList() const;
public:
    void ThreadEnd();
};
