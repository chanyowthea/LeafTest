...
func (*StartFight) Descriptor() ([]byte, []int) {
	return fileDescriptor_fight_71b9d79f3cc32499, []int{0}
}
...
func (dst *StartFight) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StartFight.Merge(dst, src)
}
...
func (*FightResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_fight_71b9d79f3cc32499, []int{1}
}
...
func (dst *FightResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FightResult.Merge(dst, src)
}
...
func (*EnterFight) Descriptor() ([]byte, []int) {
	return fileDescriptor_fight_71b9d79f3cc32499, []int{2}
}
...
func (dst *EnterFight) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnterFight.Merge(dst, src)
}
...
func init() { proto.RegisterFile("fight.proto", fileDescriptor_fight_71b9d79f3cc32499) }

var fileDescriptor_fight_71b9d79f3cc32499 = []byte{
